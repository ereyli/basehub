...
/**
 * NFTCollectionDeployerNoEarlyAccess – Ink, Soneium vb. için.
 * Early Access Pass sadece Base'de mevcut; bu ağlarda EARLY_ACCESS_NFT kontrolü yok.
 * Tüm kullanıcılar FEE_NFT_COLLECTION (0.002 ETH) öder.
 */
contract NFTCollectionDeployerNoEarlyAccess {
