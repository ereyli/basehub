...
const CAST_SHARE = {
  ...
  'deploy-b20': 'Launch and trade Base-native B20 tokens on BaseHub with direct deploys and fair bonding curves.',
...
const PRODUCTS_ALL = [
  ...
  { id: 'deploy-b20', path: '/deploy-b20', label: 'B20', title: 'B20 Launchpad', description: 'Launch and trade Base-native B20 tokens with fair bonding curves', castShareText: CAST_SHARE['deploy-b20'], category: CATEGORIES.DEPLOY, color: '#2563eb', icon: 'Rocket', iconImage: '/crypto-logos/basahub logo/B20.svg', xpReward: '5000 XP', bonusXP: 'Base mainnet', networks: ['base'] },
