...
export const PRODUCTS = [
  ...
  { id: 'flip', path: '/flip', label: 'Coinflip', title: 'Coin Flip', description: 'Flip a coin and earn XP', category: CATEGORIES.GAMING, color: '#f59e0b', icon: 'Coins', iconImage: '/crypto-logos/basahub logo/CoinFlip.png', xpReward: '60 XP', bonusXP: '+500 XP (Win)', networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'dice', path: '/dice', label: 'Dice Roll', title: 'Dice Roll', description: 'Roll dice and earn XP', category: CATEGORIES.GAMING, color: '#10b981', icon: 'Dice1', iconImage: '/crypto-logos/basahub logo/DiceRoll.png', xpReward: '60 XP', bonusXP: '+1500 XP (Win)', networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'slot', path: '/slot', label: 'Slots', title: 'Crypto Slots', description: 'Spin the reels and win XP', category: CATEGORIES.GAMING, color: '#dc2626', icon: 'Gift', iconImage: '/crypto-logos/basahub logo/CryptoSloth.png', xpReward: '60 XP', bonusXP: '+2000 XP (Combo)', networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'lucky', path: '/lucky', label: 'Lucky Number', title: 'Lucky Number', description: 'Guess 1-10 and earn XP', category: CATEGORIES.GAMING, color: '#3b82f6', icon: 'RotateCcw', iconImage: '/crypto-logos/basahub logo/luckynumber.png', xpReward: '60 XP', bonusXP: '+1000 XP (Win)', networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
  ...
  { id: 'deploy', path: '/deploy', label: 'Deploy Token', title: 'Deploy Token', description: 'Create your own ERC20 token', category: CATEGORIES.DEPLOY, color: '#f59e0b', icon: 'Coins', iconImage: '/crypto-logos/basahub logo/ERC20.png', xpReward: '50 XP', bonusXP: null, networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'deploy-erc721', path: '/deploy-erc721', label: 'ERC721', title: 'Deploy ERC721', description: 'Deploy your own NFT contract', category: CATEGORIES.DEPLOY, color: '#06b6d4', icon: 'Package', iconImage: '/crypto-logos/basahub logo/ERC-721.png', xpReward: '100 XP', bonusXP: null, networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'deploy-erc1155', path: '/deploy-erc1155', label: 'ERC1155', title: 'Deploy ERC1155', description: 'Deploy multi-token contract', category: CATEGORIES.DEPLOY, color: '#8b5cf6', icon: 'Factory', iconImage: '/crypto-logos/basahub logo/ERC-1155.png', xpReward: '100 XP', bonusXP: null, networks: ['base', 'ink', 'soneium', 'katana', 'arc-restnet', 'robinhood-testnet'] },
