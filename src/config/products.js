...
export const PRODUCTS = [
  ...
  { id: 'flip', path: '/flip', label: 'Coinflip', title: 'Coin Flip', description: 'Flip a coin and earn XP', castShareText: CAST_SHARE['flip'], category: CATEGORIES.GAMING, color: '#f59e0b', icon: 'Coins', iconImage: '/crypto-logos/basahub logo/CoinFlip.png', xpReward: '150 XP', bonusXP: '+500 XP (Win)', networks: ['base', 'ink', 'soneium', 'katana', 'megaeth', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'dice', path: '/dice', label: 'Dice Roll', title: 'Dice Roll', description: 'Roll dice and earn XP', castShareText: CAST_SHARE['dice'], category: CATEGORIES.GAMING, color: '#10b981', icon: 'Dice1', iconImage: '/crypto-logos/basahub logo/DiceRoll.png', xpReward: '150 XP', bonusXP: '+1500 XP (Win)', networks: ['base', 'ink', 'soneium', 'katana', 'megaeth', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'slot', path: '/slot', label: 'Slots', title: 'Crypto Slots', description: 'Spin the reels and win XP', castShareText: CAST_SHARE['slot'], category: CATEGORIES.GAMING, color: '#dc2626', icon: 'Gift', iconImage: '/crypto-logos/basahub logo/CryptoSloth.png', xpReward: '150 XP', bonusXP: '+2000 XP (Combo)', networks: ['base', 'ink', 'soneium', 'katana', 'megaeth', 'arc-restnet', 'robinhood-testnet'] },
  { id: 'lucky', path: '/lucky', label: 'Lucky Number', title: 'Lucky Number', description: 'Guess 1-10 and earn XP', castShareText: CAST_SHARE['lucky'], category: CATEGORIES.GAMING, color: '#3b82f6', icon: 'RotateCcw', iconImage: '/crypto-logos/basahub logo/luckynumber.png', xpReward: '150 XP', bonusXP: '+1000 XP (Win)', networks: ['base', 'ink', 'soneium', 'katana', 'megaeth', 'arc-restnet', 'robinhood-testnet'] },
  ...
  { id: 'nft-launchpad', path: '/nft-launchpad', label: 'NFT Launchpad', title: 'NFT Launchpad', description: 'Create your own NFT collection. Upload art or generate with AI, then deploy on Base, Ink, Soneium or MegaETH.', castShareText: CAST_SHARE['nft-launchpad'], category: CATEGORIES.NFT, color: '#3b82f6', icon: 'Package', xpReward: '2000 XP', bonusXP: '200 XP per mint', networks: ['base', 'ink', 'soneium', 'megaeth'], isX402: true, holderDiscount: 'Pass: 0.0005 ETH deploy (Base)' },
  { id: 'nft-launchpad-explore', path: '/nft-launchpad?tab=explore', label: 'Launched NFTs', title: 'Launched Collections', description: 'Browse and mint from NFT collections launched on Base, Ink, Soneium or MegaETH', castShareText: CAST_SHARE['nft-launchpad-explore'], category: CATEGORIES.NFT, color: '#10b981', icon: 'LayoutGrid', xpReward: '200 XP', bonusXP: null, networks: ['base', 'ink', 'soneium', 'megaeth'] },
]
