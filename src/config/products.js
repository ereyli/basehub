...
export const NAV_SECTIONS = {
  ...
  deploy: ['deploy-b20', 'deploy', 'deploy-erc721', 'deploy-erc1155', 'deploy-erc8004'],
...
const PRODUCTS_ALL = [
  ...
  { id: 'deploy-b20', path: '/deploy-b20', label: 'B20', title: 'B20 Launchpad', description: 'Base-native B20 asset and stablecoin launches', castShareText: CAST_SHARE['deploy-b20'], category: CATEGORIES.DEPLOY, color: '#2563eb', icon: 'Rocket', xpReward: 'Coming Soon', bonusXP: 'Base', networks: ['base'] },
