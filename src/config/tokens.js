...
// AppToken interface (JavaScript - no interface needed)
...
export function saveCustomToken(token) {
  try {
    ...
    existing[token.symbol] = { ...toStore, sdkToken: token.sdkToken };
...
export function getTokenByAddress(address) | undefined {
