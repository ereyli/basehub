  ...
  const games = [
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/GM.png" alt="GM Game" loading="lazy" style={{ width: '50px', height: '50px', borderRadius: '12px' }} />,
      path: '/gm',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/GN.png" alt="GN Game" loading="lazy" style={{ width: '50px', height: '50px', borderRadius: '12px' }} />,
      path: '/gn',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/AINFTLAUNCHPAD.png" alt="AI NFT Launchpad" loading="lazy" style={{ width: '50px', height: '50px', borderRadius: '12px' }} />,
      path: '/ai-nft',
      color: 'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)',
      xpReward: '500 XP',
      bonusXP: null
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/ERC-721.png" alt="Deploy ERC721" loading="lazy" style={{ width: '50px', height: '50px', borderRadius: '12px' }} />,
      path: '/deploy-erc721',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/ERC20.png" alt="Deploy Token" loading="lazy" style={{ width: '50px', height: '50px', borderRadius: '12px' }} />,
      path: '/deploy',
      color: 'linear-gradient(135deg, #10b981 0%, #059669 100%)',
      xpReward: '50 XP',
      bonusXP: null
