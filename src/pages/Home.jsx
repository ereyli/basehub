  ...
  const games = [
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/GM.png" alt="GM Game" style={{ width: '40px', height: '40px' }} />,
      path: '/gm',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/GN.png" alt="GN Game" style={{ width: '40px', height: '40px' }} />,
      path: '/gn',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/AINFTLAUNCHPAD.png" alt="AI NFT Launchpad" style={{ width: '40px', height: '40px' }} />,
      path: '/ai-nft',
      color: 'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)',
      xpReward: '500 XP',
      bonusXP: null
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/ERC-721.png" alt="Deploy ERC721" style={{ width: '40px', height: '40px' }} />,
      path: '/deploy-erc721',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/ERC20.png" alt="Deploy Token" style={{ width: '40px', height: '40px' }} />,
      path: '/deploy',
      color: 'linear-gradient(135deg, #10b981 0%, #059669 100%)',
      xpReward: '50 XP',
      bonusXP: null
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/ERC-1155.png" alt="Deploy ERC1155" style={{ width: '40px', height: '40px' }} />,
      path: '/deploy-erc1155',
    ...
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/CoinFlip.png" alt="Coin Flip" style={{ width: '40px', height: '40px' }} />,
      path: '/flip',
      color: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
      xpReward: '10 XP',
      bonusXP: '+500 XP (Win)'
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/luckynumber.png" alt="Lucky Number" style={{ width: '40px', height: '40px' }} />,
      path: '/lucky',
      color: 'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)',
      xpReward: '10 XP',
      bonusXP: '+1000 XP (Win)'
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/DiceRoll.png" alt="Dice Roll" style={{ width: '40px', height: '40px' }} />,
      path: '/dice',
      color: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)',
      xpReward: '10 XP',
      bonusXP: '+1500 XP (Win)'
    },
    {
      ...
      icon: <img src="/crypto-logos/basahub logo/CryptoSloth.png" alt="Crypto Slots" style={{ width: '40px', height: '40px' }} />,
      path: '/slot',
