...
export const useDeployERC721 = () => {
  ...
  const deployERC721 = async (name, symbol, imageFile) => {
    ...
    try {
      ...
      // Limit string lengths for Farcaster compatibility (like ERC20)
      ...
      // TODO: Add bytecode here after manual deployment
      ...
      const constructorData = encodeAbiParameters(
        ...
        [shortName, shortSymbol, metadataUrl]
      )
      ...
      try {
        ...
        // await updateQuestProgress('erc721Deployed', 1) // Temporarily disabled for testing
      } catch (xpError) {
