...
export const useDeployERC1155 = () => {
  ...
  const deployERC1155 = async (name, symbol, uri) => {
    ...
    try {
      ...
      // Use original parameters (like the working commit)
      console.log('📝 Using original parameters:', { name, symbol })
      ...
      // Use sendTransaction with manual encoding for Farcaster compatibility (like ERC20)
      ...
      // Update quest progress for ERC1155 deployment (independent of XP)
      try {
        console.log('🎯 Updating quest progress for ERC1155 deployment!')
