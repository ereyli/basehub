...
// OUR SWAP AGGREGATOR V3 SAFE (VITE_SWAP_AGGREGATOR_ADDRESS can override this per environment)
const DEFAULT_SWAP_AGGREGATOR = '0x2bc0D802889dE33823495D42e9A7E85285F5a047';
const SWAP_AGGREGATOR = (import.meta.env.VITE_SWAP_AGGREGATOR_ADDRESS || DEFAULT_SWAP_AGGREGATOR) as `0x${string}`;

// Aggregator V3 Safe ABI - generic allowlisted router execution
